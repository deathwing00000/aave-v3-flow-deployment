...
export const NETWORKS_RPC_URL: iParamsPerNetwork<string> = {
  ...
  [eFlowNetwork.main]: "https://mainnet.evm.nodes.onflow.org",
  [eFlowNetwork.testnet]: "https://testnet.evm.nodes.onflow.org",
...
export const LIVE_NETWORKS: iParamsPerNetwork<boolean> = {
  ...
  [eFlowNetwork.main]: true,
  [eFlowNetwork.testnet]: true,
};
