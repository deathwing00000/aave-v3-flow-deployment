...
export const CommonsConfig: ICommonConfiguration = {
  ...
  OracleQuoteUnit: "8",
  WrappedNativeTokenSymbol: "WFLOW",
  ChainlinkAggregator: {
    [eFlowNetwork.main]: {
      LINK: ZERO_ADDRESS,
      USDC: "0xBEfB2b2B48fdEece45253b2eD008540a23d25AFE",
      DAI: ZERO_ADDRESS,
      WBTC: ZERO_ADDRESS,
      WETH: ZERO_ADDRESS,
      USDT: ZERO_ADDRESS,
    ...
    [eFlowNetwork.testnet]: {
      ...
      ANKRFLOW: "0x07AFB6D7a2ee22C8B171F12792846dB92286a8c1",
    },
  },
  ReserveFactorTreasuryAddress: {
    ...
    [eFlowNetwork.main]: ZERO_ADDRESS,
    [eFlowNetwork.testnet]: ZERO_ADDRESS,
  },
  FallbackOracle: {
