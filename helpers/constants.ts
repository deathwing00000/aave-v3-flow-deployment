...
export const WRAPPED_NATIVE_TOKEN_PER_NETWORK: { [network: string]: string } = {
  ...
  [eFlowNetwork.main]: "0xd3bF53DAC106A0290B0483EcBC89d40FcC961f3e",
  [eFlowNetwork.testnet]: "0xd3bF53DAC106A0290B0483EcBC89d40FcC961f3e",
};
...
export const POOL_ADMIN: Record<string, string> = {
  ...
  [eFlowNetwork.main]: "0xC8419191Cb1A3bF4FfC022D01f857D5AFdeD01ba",
  [eFlowNetwork.testnet]: "0xC8419191Cb1A3bF4FfC022D01f857D5AFdeD01ba",
};
